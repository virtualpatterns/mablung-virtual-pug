...
function __getNode(__local = {}, __option = {}) {
  ...
  function __getNode(__option = {}) {
    ...
    __node.push(...[__option.convertToNode('You put the em')].flat())
    ...
    __node.push(
      __option.createNode(
        ...
        (() => {
          ...
          __node.push(...[__option.convertToNode('pha')].flat())
    ...
    __node.push(...[__option.convertToNode('sis on the wrong syl')].flat())
    ...
    __node.push(
      __option.createNode(
        ...
        (() => {
          ...
          __node.push(...[__option.convertToNode('la')].flat())
    ...
    __node.push(...[__option.convertToNode('ble.')].flat())
