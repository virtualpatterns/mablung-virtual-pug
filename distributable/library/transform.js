...
var _andAttributeNode = _interopRequireDefault(require("./node/and-attribute-node.js"));

var _attributeNode = _interopRequireDefault(require("./node/attribute-node.js"));

var _blockNode = _interopRequireDefault(require("./node/block-node.js"));

var _eachNode = _interopRequireDefault(require("./node/each-node.js"));

var _unrecognizedMessageTransformError = require("./error/unrecognized-message-transform-error.js");
...
class Transform {
  ...
  static async createModuleFromPath(path, option = {
    ...
    let extension = _path.default.extname(__filename);
  ...
  static async formatSource(source) {
    let configuration = _json.default.parse(await _fsExtra.default.readFile(require.resolve('./transform.babelrc.json')), {
      'encoding': 'utf-8'
    });
