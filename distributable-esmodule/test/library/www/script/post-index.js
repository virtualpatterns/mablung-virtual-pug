(() => {
  ...
  var require_vnode = __commonJS((exports, module) => {
    ...
    module.exports = VirtualNode2;
    var noProperties = {};
    var noChildren = [];
    function VirtualNode2(tagName, properties, children, key, namespace) {
    ...
    VirtualNode2.prototype.version = version;
    VirtualNode2.prototype.type = "VirtualNode";
  });

  // node_modules/virtual-dom/vnode/vtext.js
  var require_vtext = __commonJS((exports, module) => {
    var version = require_version();
    module.exports = VirtualText2;
    function VirtualText2(text) {
      this.text = String(text);
    }
    VirtualText2.prototype.version = version;
    VirtualText2.prototype.type = "VirtualText";
  });
  ...
  var require_h = __commonJS((exports, module) => {
    var h2 = require_virtual_hyperscript();
    module.exports = h2;
  });

  // distributable-esmodule/test/library/www/script/pre-index.js
  ...
  // distributable-esmodule/library/utility.js
  const html_to_vdom = __toModule(require_html_to_vdom2());
  const h = __toModule(require_h());
  const vnode = __toModule(require_vnode());
  const vtext = __toModule(require_vtext());
  const ConvertToVirtualNode = html_to_vdom.default({VNode: vnode.default, VText: vtext.default});
  class Utility {
    ...
    static createNode(name, property, childNode) {
      ...
      return h.default(name, {attributes: property}, childNode);
    }
  ...
  var utility_default = Utility;

  // distributable-esmodule/test/library/www/script/element.js
  ...
  function element_default(__local = {}, __utility = utility_default) {
