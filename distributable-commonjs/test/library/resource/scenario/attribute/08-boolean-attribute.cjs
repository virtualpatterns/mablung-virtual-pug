    ...
    __node.push(
      __createNode(
        ...
        (() => {
          ...
          __addAttribute('type', 'checkbox', __attributeNode)

          __addAttribute('checked', true, __attributeNode)
    ...
    __node.push(
      __createNode(
        ...
        (() => {
          ...
          __addAttribute('checked', false, __attributeNode)
    ...
    __node.push(
      __createNode(
        ...
        (() => {
          ...
          __addAttribute('checked', true.toString(), __attributeNode)
