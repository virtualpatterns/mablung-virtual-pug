...
function __getNode(__local = {}, __option = {}) {
  ...
  function __getNode(__option = {}) {
    ...
    __node.push(
      __option.createNode(
        ...
        (() => {
          ...
          __addAttribute('class', classes, __attributeNode)
    ...
    __node.push(...[__option.convertToNode(' ')].flat()) // the class attribute may also be repeated to merge arrays
    ...
    __node.push(
      __option.createNode(
        ...
        (() => {
          ...
          __addAttribute('class', 'bang', __attributeNode)

          __addAttribute('class', classes, __attributeNode)

          __addAttribute('class', ['bing'], __attributeNode)
