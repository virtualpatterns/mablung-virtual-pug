    ...
    __node.push(
      __createNode(
        ...
        (() => {
          ...
          __node.push(...[__option.convertToNode('if (usingPug)')].flat())

          __node.push(...[__option.convertToNode('\n')].flat())

          __node.push(
            ...[
              __option.convertToNode("  console.log('you are awesome')")
            ].flat()
          )

          __node.push(...[__option.convertToNode('\n')].flat())

          __node.push(...[__option.convertToNode('else')].flat())

          __node.push(...[__option.convertToNode('\n')].flat())

          __node.push(
            ...[__option.convertToNode("  console.log('use pug')")].flat()
          )
