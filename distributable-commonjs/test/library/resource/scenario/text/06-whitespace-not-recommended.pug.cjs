...
function __getNode(__local = {}, __option = {}) {
  ...
  function __getNode(__option = {}) {
    ...
    __node.push(...[__option.convertToNode('Hey, check out ')].flat())
    ...
    __node.push(
      __createNode(
        ...
        (() => {
          ...
          __node.push(...[__option.convertToNode('this picture')].flat())
    ...
    __node.push(...[__option.convertToNode(' of my cat!')].flat())
