          ...
          __node.push(
            __createNode(
              ...
              (() => {
                ...
                __node.push(...[__option.convertToNode('My Site')].flat())
          ...
          __node.push(
            __createNode(
              ...
              (() => {
                ...
                __addAttribute('src', '/javascripts/jquery.js', __attributeNode)
          ...
          __node.push(
            __createNode(
              ...
              (() => {
                ...
                __addAttribute('src', '/javascripts/app.js', __attributeNode)
