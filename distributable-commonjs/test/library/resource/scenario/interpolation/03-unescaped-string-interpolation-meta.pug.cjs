    ...
    __node.push(
      __option.createNode(
        ...
        (() => {
          ...
          __node.push(
            ...[
              __option.convertToNode('Escaping works with #{interpolation}')
            ].flat()
          )
    ...
    __node.push(
      __option.createNode(
        ...
        (() => {
          ...
          __node.push(
            ...[__option.convertToNode('Interpolation works with ')].flat()
          )
          ...
          __node.push(...[__option.convertToNode(' too!')].flat())
